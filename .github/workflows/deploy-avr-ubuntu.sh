...
curl "https://codeload.github.com/Sestre-oratek/oratek-avr-boards/zip/$VERSIONNUMBER" >> oratek-avr-boards.zip
...
cd jsonFiles
jq .version="\"$VERSIONNUMBER\"" avrTemplate.json | jq .size="\"${SIZE}\"" | jq .checksum="\"SHA-256:${SUM}\"" | jq .archiveFileName="\"oratek-avr-boards-$VERSIONNUMBER.zip\"" | jq .url="\"https://github.com/Sestre-oratek/oratek-avr-boards/archive/$VERSIONNUMBER.zip\"" >> temp.json
